...
nte.outerHTML = '<nav class="navbar navbar-expand-sm fixed-top" style="background-color:#8bc34a; padding:0;" id="navbar"><div class="logo"><img src="asset/logo.png" alt="logo" width="50" height="43"></div><div class="container-fluid justify-content-end"><button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#header">≡</button><div class="collapse navbar-collapse justify-content-end" id="header"><ul class="navbar-nav"></ul></div></div></nav><div id="header_trick"></div>';
